...
import fun.oop.framework.exception.BusinessAssertException;
 ...
 *   }}</pre>
 * <p>
 * In this example, {@code checkArgument} throws an {@code BusinessAssertException} to indicate
...
public final class P {
   ...
   */
     ...
     * @throws BusinessAssertException if {@code index} is negative or is not less than {@code size}
     ...
     * @param size  the size of that array, list or string
     * @return the value of {@code index}
     * @throws BusinessAssertException if {@code index} is negative or is greater than {@code size}
     * @throws BusinessAssertException if {@code size} is negative
     */
     ...
     * @param size  the size of that array, list or string
     * @throws BusinessAssertException if either index is negative or is greater than {@code size},
